...
### Team Member  — Exzavier Pickering
...
- `minutes.md` — meeting records (team leader only)
...
2. Create a branch named `member/your-name-readme`.
3. Edit only your own member section in this file.
4. Stage the change, write a clear commit message, and commit it in Source Control.
5. Publish the branch, open a pull request on GitHub, and ask the team leader to merge it into `main`.

Do not edit `minutes.md` unless you are the team leader.
